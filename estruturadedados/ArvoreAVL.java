...
public class ArvoreAVL {
    ...
    private Elemento rotacionarEsquerda(Elemento arvore) {
        IDado aux = arvore.dado;
        arvore.dado = arvore.direita.dado;
        Elemento novo = new Elemento(aux);
        novo.direita = arvore.direita.esquerda;
        novo.esquerda = arvore.esquerda;
        arvore.direita = arvore.direita.direita;
        arvore.esquerda = novo;
        return arvore;
    }

    private Elemento rotacionarDireita(Elemento arvore) {
        IDado aux = arvore.dado;
        arvore.dado = arvore.esquerda.dado;
        Elemento novo = new Elemento(aux);
        novo.esquerda = arvore.esquerda.direita;
        novo.direita = arvore.direita;
